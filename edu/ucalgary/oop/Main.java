...
public class Main {
    ...
    public static void main(String[] args) throws InvalidInputException{
        ...
        vets.add(new Veterinarian(1, "Dr. Sarah Thompson", "Surgery"));
        vets.add(new Veterinarian(2, "Dr. John Miller", "Dermatology"));
        receptionists.add(new Receptionist(3, "Emily Carter"));
        receptionists.add(new Receptionist(4, "Michael Brown"));
